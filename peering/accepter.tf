...
resource "aws_route" "accepter" {
  ...
  depends_on                = ["data.aws_route_tables.accepter", "aws_vpc_peering_connection_accepter.accepter", "aws_vpc_peering_connection.requester", "null_resource.delay"]
}
...
resource "null_resource" "delay" {
  ...
  triggers = {
    "before" = "${aws_vpc_peering_connection_accepter.accepter.id}"
  }
}
